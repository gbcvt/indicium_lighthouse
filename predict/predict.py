...
previsao_demanda.py
--------------------
Preve a demanda mensal do produto "Bussola de Bordo 702" usando um
baseline de media movel dos ultimos 3 meses, e compara com os valores
reais do primeiro trimestre de 2026 usando o MAE (Mean Absolute Error).

Le os CSVs originais (products, product_variants, orders, order_items),
monta um dataset unificado de vendas mensais do produto, treina o
baseline com dados ate 31/12/2025 e testa em jan/fev/mar de 2026.

Bibliotecas usadas:
  - pandas (biblioteca externa, precisa instalar: pip install pandas)
  - os, re, sys, zipfile, tempfile, shutil (padrao do Python 3)
